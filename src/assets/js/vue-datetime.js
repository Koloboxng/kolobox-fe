...
(function (global, factory) {
        ...
        render: function () {
            ...
            return _c('div', {
                ...
                return _c('div', {
                    ...
                    class: {
                        'vdatetime-calendar__month__day--selected': day.selected, 'vdatetime-calendar__month__day--disabled': day.disabled
                    },
                    on: {
    ...
    var DatetimeTimePicker = {
        render: function () {
            ...
            return _c('div', {
                class: {
                    'vdatetime-time-picker': true, 'vdatetime-time-picker__with-suffix': _vm.use12Hour
                }
            }, [_c('div', {
                ref: "hourList",
                ...
                return _c('div', {
                    ...
                    class: {
                        'vdatetime-time-picker__item--selected': hour.selected, 'vdatetime-time-picker__item--disabled': hour.disabled
                    },
                    on: {
                        "click": function ($event) {
                            _vm.selectHour(hour);
                ...
                return _c('div', {
                    staticClass: "vdatetime-time-picker__item",
                    class: {
                        'vdatetime-time-picker__item--selected': minute.selected, 'vdatetime-time-picker__item--disabled': minute.disabled
                    },
                    on: {
                        "click": function ($event) {
        ...
        render: function () {
            ...
            return _c('div', {
                ...
                return _c('div', {
                    ...
                    class: {
                        'vdatetime-year-picker__item--selected': year.selected, 'vdatetime-year-picker__item--disabled': year.disabled
                    },
                    on: {
                        "click": function ($event) {
                            _vm.select(year);
    ...
    var DatetimePopup = {
        render: function () {
            ...
            }, [_vm._v(_vm._s(_vm.phrases.cancel))]), _vm._v(" "), _c('div', {
